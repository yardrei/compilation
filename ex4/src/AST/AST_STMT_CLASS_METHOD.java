...
public class AST_STMT_CLASS_METHOD extends AST_STMT {
    public String id;
    public AST_VAR var;
    ...
    /* CONSTRUCTOR(S) */
    /******************/
    public AST_STMT_CLASS_METHOD(String id, AST_VAR var, AST_LIST<AST_EXP> list, int line) {
        super(line);
    ...
    /******************************************************/
    /* The default message for an stmt class method AST node */
    /******************************************************/
    public void PrintMe() {
        /*************************************************/
        /* AST CLASS [var DOT] ID '('[exp [COMMA exp]*]')' */
        /*************************************************/
        System.out.print("AST NODE STMT CLASS METHOD\n");
    ...
    public TEMP IRme() {
        ...
        //Function
        if (var == null) {
            IR.getInstance().Add_IRcommand(new IRcommand_Function_Call(dst, id, func.numOfParams, true));
        }
        //Method
        else {
            TEMP locTemp = var.IRme();
            IR.getInstance().Add_IRcommand(new IRcommand_Method_Call(dst, locTemp, func.location, func.numOfParams, true));
        }
        return dst;
    }
}
